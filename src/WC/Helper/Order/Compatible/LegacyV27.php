...
class LegacyV27 extends AbstractWrapper implements OrderCompatible
{
    ...
    {
        return $this->set_order_meta(self::META_NAME_ORDER_KEY, $value);
    }
    ...
    {
        return $this->set_order_meta(self::META_NAME_CUSTOMER_ID, $value);
    }
    ...
    {
        return $this->set_order_meta(self::META_NAME_BILLING_LAST_NAME, $value);
    }

    public function set_billing_company($value)
    {
        return $this->set_order_meta(self::META_NAME_BILLING_COMPANY, $value);
    }

    public function set_billing_address_1($value)
    {
        return $this->set_order_meta(self::META_NAME_BILLING_ADDRESS_1, $value);
    }

    public function set_billing_address_2($value)
    {
        return $this->set_order_meta(self::META_NAME_BILLING_ADDRESS_2, $value);
    }

    public function set_billing_city($value)
    {
        return $this->set_order_meta(self::META_NAME_BILLING_CITY, $value);
    }

    public function set_billing_state($value)
    {
        return $this->set_order_meta(self::META_NAME_BILLING_STATE, $value);
    }

    public function set_billing_postcode($value)
    {
        return $this->set_order_meta(self::META_NAME_BILLING_POSTCODE, $value);
    }

    public function set_billing_country($value)
    {
        return $this->set_order_meta(self::META_NAME_BILLING_COUNTRY, $value);
    }

    public function set_billing_email($value)
    {
        return $this->set_order_meta(self::META_NAME_BILLING_EMAIL, $value);
    }

    public function set_billing_phone($value)
    {
        return $this->set_order_meta(self::META_NAME_BILLING_PHONE, $value);
    }

    public function set_shipping_first_name($value)
    {
        return $this->set_order_meta(self::META_NAME_SHIPPING_FIRST_NAME, $value);
    }

    public function set_shipping_last_name($value)
    {
        return $this->set_order_meta(self::META_NAME_SHIPPING_LAST_NAME, $value);
    }

    public function set_shipping_company($value)
    {
        return $this->set_order_meta(self::META_NAME_SHIPPING_COMPANY, $value);
    }

    public function set_shipping_address_1($value)
    {
        return $this->set_order_meta(self::META_NAME_SHIPPING_ADDRESS_1, $value);
    }

    public function set_shipping_address_2($value)
    {
        return $this->set_order_meta(self::META_NAME_SHIPPING_ADDRESS_2, $value);
    }

    public function set_shipping_city($value)
    {
        return $this->set_order_meta(self::META_NAME_SHIPPING_CITY, $value);
    }

    public function set_shipping_state($value)
    {
        return $this->set_order_meta(self::META_NAME_SHIPPING_STATE, $value);
    }

    public function set_shipping_postcode($value)
    {
        return $this->set_order_meta(self::META_NAME_SHIPPING_POSTCODE, $value);
    }

    public function set_shipping_country($value)
    {
        return $this->set_order_meta(self::META_NAME_SHIPPING_COUNTRY, $value);
    }

    public function set_payment_method($payment_method = '')
    {
        return $this->set_order_meta(self::META_NAME_PAYMENT_METHOD, $payment_method);
    }

    public function set_payment_method_title($value)
    {
        return $this->set_order_meta(self::META_NAME_PAYMENT_METHOD_TITLE, $value);
    }

    public function set_transaction_id($value)
    {
        return $this->set_order_meta(self::META_NAME_TRANSACTION_ID, $value);
    }

    public function set_customer_ip_address($value)
    {
        return $this->set_order_meta(self::META_NAME_CUSTOMER_IP_ADDRESS, $value);
    }

    public function set_customer_user_agent($value)
    {
        return $this->set_order_meta(self::META_NAME_CUSTOMER_USER_AGENT, $value);
    }

    public function set_created_via($value)
    {
        return $this->set_order_meta(self::META_NAME_CREATED_VIA, $value);
    }

    public function set_customer_note($value)
    {
        return $this->set_order_meta(self::META_NAME_CUSTOMER_NOTE, $value);
    }

    public function set_date_completed($date = null)
    {
        return $this->set_order_meta(self::META_NAME_DATE_COMPLETED, $date);
    }

    public function set_date_paid($date = null)
    {
        return $this->set_order_meta(self::META_NAME_DATE_PAID, $date);
    }

    public function set_cart_hash($value)
    {
        return $this->set_order_meta(self::META_NAME_CART_HASH, $value);
    }
    ...
    {
        return $this->get_order_meta(self::META_NAME_PARENT_ID, true);
    }

    public function get_status($context = 'view')
    {
        return $this->get_order_meta(self::META_NAME_STATUS, true);
    }

    public function get_version($context = 'view')
    {
        return $this->get_order_meta(self::META_NAME_VERSION, true);
    }

    public function get_prices_include_tax($context = 'view')
    {
        return $this->get_order_meta(self::META_NAME_PRICES_INCLUDE_TAX, true);
    }
    ...
    {
        return $this->get_order_meta(self::META_NAME_DISCOUNT_TOTAL, true);
    }

    public function get_discount_tax($context = 'view')
    {
        return $this->get_order_meta(self::META_NAME_DISCOUNT_TAX, true);
    }

    public function get_shipping_total($context = 'view')
    {
        return $this->get_order_meta(self::META_NAME_SHIPPING_TOTAL, true);
    }

    public function get_shipping_tax($context = 'view')
    {
        return $this->get_order_meta(self::META_NAME_SHIPPING_TAX, true);
    }

    public function get_cart_tax($context = 'view')
    {
        return $this->get_order_meta(self::META_NAME_CART_TAX, true);
    }

    public function get_total($context = 'view')
    {
        return $this->get_order_meta(self::META_NAME_TOTAL, true);
    }
    ...
    {
        return $this->get_order_meta(self::META_NAME_ORDER_CURRENCY, true);
    }
